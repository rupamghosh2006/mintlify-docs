...
> A short overview of each primitive, with links to deeper [Essentials](/essentials/architecture) pages.
...
- [Essentials](/essentials/architecture) - deeper coverage of every concept on this page
