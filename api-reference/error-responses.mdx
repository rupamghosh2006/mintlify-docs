...
description: "Comprehensive guide to HTTP error responses and their meanings across all HydraDB API endpoints"
---

All HydraDB API endpoints follow a consistent error response format. This page documents the standard HTTP error codes and their corresponding response structures.
...
1. **Verify IDs**: Double-check tenant_id, sub_tenant_id, and id values
