...
<Tabs>
  <Tab title="API Request">
    ```bash expandable
    curl -X 'POST' \
    'https://api.hydradb.com/embeddings/search_raw_embeddings' \
...
- **Compatibility**: Ensure your embedding model matches HydraDB's expected format
...
```json
{
  "chunk_ids": [
    ...
    "HydraEmbeddings456_0",
    "HydraEmbeddings456_1",
    "HydraEmbeddings123_2",   
    "HydraEmbeddings123_8"
  ],
  "scores": [
    0.95,
    0.89,
