---
title: "User Memory"
description: "Add memories to HydraDB that can be used by your agents for learning about your users. This API allows you to ingest memories in various formats including text, markdown, and user-assistant pairs."
...
Controls whether HydraDB extracts insights, likes, dislikes, preferences, and outcomes from the content. If nothing is specified, default behaviour is `false`
...
| `metadata`             | object  | No       | Dict of tenant-level metadata                |
| `additional_metadata`  | object  | No       | Dict of document-level metadata              |
