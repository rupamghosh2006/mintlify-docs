...
| Filter category | Key (all SDKs) | Targets |
|---|---|---|
| Tenant-level metadata | `metadata` | Fields defined in `tenant_metadata_schema` |
| Document-level metadata | `additional_metadata` | Fields attached per-document at ingestion |
