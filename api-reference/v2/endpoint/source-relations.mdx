---
title: "List context relations"
openapi: "api-reference/v2/openapi.json GET /context/relations"
description: "Inspect graph relations for one source or an entire collection."
---
...
<Tip>
  **Related Resources**
  ...
  - **Indexing status:** [Check indexing status](/api-reference/v2/endpoint/source-status) - confirm the graph is complete
