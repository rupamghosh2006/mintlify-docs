...
| `metadata` | object | Tenant-level metadata. Filterable at recall time. |
...
<Info>
Though app_knowledge is an available option. We *recommend* storing the content as a markdown file and using file upload through `upload_knowledge` for better results.
</Info>
