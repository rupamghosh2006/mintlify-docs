...
- **Common mistakes.** Check [Check indexing status](/api-reference/v2/endpoint/source-status) for recently ingested documents before querying. If you omit `collection`, HydraDB queries the default collection; use [List Collections](/api-reference/v2/endpoint/list-sub-tenants) to discover available IDs.
</Warning>
...
- **Confirm indexing:** [Check indexing status](/api-reference/v2/endpoint/source-status) - wait for `completed` (or `graph_creation`)
...
- **Read more:** [Choose a query](/api-reference/v2/endpoint/query-overview)
</Tip>
