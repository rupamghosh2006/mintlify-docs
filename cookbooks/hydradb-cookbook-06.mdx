...
ℹ️
> **All code in this cookbook is real.** Base URL: `https://api.hydradb.com`. Get your API key at [app.hydradb.com](app.hydradb.com).
...
class ChiefOfStaffOrchestrator:
    ...
    def _extract_params(self, task: str, schema: dict, user_id: str, session_id: str) -> dict:
        ...
        HydraDB should be used for retrieval (`/recall/full_recall`); parameter extraction
...
def generate_execution_plan(
    ...
    user_prefs = client.recall.recall_preferences(
        tenant_id=TENANT_ID,
        sub_tenant_id=f"user-{user_id}",
