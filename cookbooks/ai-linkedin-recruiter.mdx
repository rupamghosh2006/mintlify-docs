...
Note: All code examples in this guide are for demonstration purposes. They show the concepts and patterns you can use when building your own AI linkedin-like application with HydraDB APIs. Follow the actual API documentation to adapt these examples to your specific use case, technology stack, and requirements.
...
const candidateProfile = {
  ...
  source: 'candidate_profile', // Source app identifier
...
class AIRecruitingSearch {
  constructor(apiKey, tenantId) {
    ...
    this.baseUrl = 'https://api.hydradb.com';
  }
  ...
  async findCandidates(query, recruiterContext = {}) {
    const searchPayload = {
      ...
      additional_context: this.buildHiringInstructions(recruiterContext)
    };
