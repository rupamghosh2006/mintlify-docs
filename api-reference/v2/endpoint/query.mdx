...
| <Field name="query_by" type='"hybrid" or "text"' /> | Retrieval method. See [Search methods](#decision-matrix). (default=`"hybrid"`) |
...
- **Read more:** [Search - Overview](/api-reference/v2/endpoint/query-overview)
</Tip>
