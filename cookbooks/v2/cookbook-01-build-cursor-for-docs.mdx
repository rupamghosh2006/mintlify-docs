...
```
Accepted: {'database': 'engineering-docs', 'status': 'accepted', 'message': 'Tenant accepted. Poll /tenants/status for readiness.'}
...
GET /tenants/status?database=engineering-docs
→ { "status": "ready" }
```
