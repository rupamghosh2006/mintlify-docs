...
- **Recently ingested sources:** Fetching immediately after ingestion may return a record before the parsed text is ready. For reliable reads, use [Check indexing status](/api-reference/v2/endpoint/source-status) first.
