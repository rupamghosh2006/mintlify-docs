...
- **Common mistakes.** Check [Source Status](/api-reference/v2/endpoint/source-status) for recently ingested documents before querying. If you omit `sub_tenant_id`, HydraDB queries the default sub-tenant; use [List Sub-Tenants](/api-reference/v2/endpoint/list-sub-tenants) to discover available IDs.
</Warning>
