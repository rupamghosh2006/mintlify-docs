...
Compared to v1, the surface is intentionally smaller  -  three groups instead of seven, one query endpoint instead of three search endpoints, one ingestion endpoint instead of two.
