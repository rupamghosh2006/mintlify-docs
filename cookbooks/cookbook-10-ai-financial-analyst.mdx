...
> **Note**: All API calls in this guide are real and ready to run. Base URL: `https://api.hydradb.com`. Get your API key by emailing [founders@hydradb.com](mailto:founders@hydradb.com) or booking a demo at [hydradb.com](https://hydradb.com).
