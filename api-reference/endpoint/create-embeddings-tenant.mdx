...
description: "API reference for Create Embeddings Tenant. Useful if you are an enterprise that has specialized embedding models trained in house."
...
<Tabs>
  <Tab title="API Request">
    ```bash
    curl --location --request POST 'https://api.hydradb.com/embeddings/create_tenant?tenant_id={TENANT_ID}' \
