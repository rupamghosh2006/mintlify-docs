...
<Tabs>
  <Tab title="API Request">
    ...
    # Single file
    curl -X POST \
      'https://api.usecortex.ai/ingestion/verify_processing?file_id=file_123&tenant_id=tenant_1234' \
      -H 'Authorization: Bearer YOUR_API_KEY'

    # Multiple files
    curl -X POST \
      'https://api.usecortex.ai/ingestion/verify_processing?file_ids=file_123&file_ids=file_456&tenant_id=tenant_1234' \
      -H 'Authorization: Bearer YOUR_API_KEY'
    ```
  </Tab>
