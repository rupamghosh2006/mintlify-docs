...
| <Field name="kind" type="email, message, ticket, knowledge_base, comment, custom" recommended /> | Tells HydraDB how to interpret `fields`. Defaults to `custom` if omitted. | Routes search by object type and selects the right parser for structured fields. |
