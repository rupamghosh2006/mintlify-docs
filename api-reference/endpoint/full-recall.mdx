...
<Tip>
  **Using the response?** Learn how to transform the raw JSON into a clean context string ready to pass into your LLM. [How to Use API Results →](/essentials/api-results)
</Tip>
